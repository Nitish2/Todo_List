package com.example.hp.todo_list.ToDo_Database;
...
public class Database extends SQLiteOpenHelper {
    ...
    public int update(Integer _id, String title, String description, String date, String status) {
        ...
        int i = db.update(MyDatabaseHelper.DATABASE_NAME, contentValues,
                MyDatabaseHelper.COLUMN_DESCRIPTION + " = " + _id, null);
        return i;
    }
